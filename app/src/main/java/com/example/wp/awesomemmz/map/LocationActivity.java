...
import com.example.wp.awesomemmz.map.service.LocationUtils;
...
public class LocationActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        tvLocationErrInfo = findViewById(R.id.tvLocationErrInfo);
        ...
        btnToMap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LaunchUtil.launchActivity(mActivity, MapActivity.class);
            }
        });
    ...
    private void requestPermission() {
        if (Build.VERSION.SDK_INT >= 23 && !isPermissionRequested) {
            ...
            ArrayList<String> permissionsList = MainHelper.getInstance().checkPermission(this, permissions);
            LogUtils.d("-----permission: " + permissionsList.size());
        ...
        try {
            if (tvLocationInfo != null) {
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        tvLocationInfo.post(new Runnable() {
                            @Override
                            public void run() {
                                if (tag == LocationUtils.RECEIVE_TAG) {
                                    tvLocationInfo.setText(str);
                                } else if (tag == LocationUtils.DIAGNOSTIC_TAG) {
                                    tvLocationErrInfo.setText(str);
                                }
                            }
                        });
                    }

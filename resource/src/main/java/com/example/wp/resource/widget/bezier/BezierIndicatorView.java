...
public class BezierIndicatorView extends View implements ViewPager.OnPageChangeListener {
    ...
    private void initattrs(AttributeSet attrs) {
        TypedArray typedArray=getContext().obtainStyledAttributes(attrs,R.styleable.BezierIndicatorView);
        mSelectedColor=typedArray.getColor(R.styleable.BezierIndicatorView_selectedColor,0xFFFFFFFF);
        mUnSelectedColor=typedArray.getColor(R.styleable.BezierIndicatorView_unSelectedColor,0xFFAAAAAA);
        mRadius=typedArray.getDimension(R.styleable.BezierIndicatorView_selectedRaduis,mRadius);
        mNomarlRadius=typedArray.getDimension(R.styleable.BezierIndicatorView_unSelectedRaduis,mNomarlRadius);
        distance=typedArray.getDimension(R.styleable.BezierIndicatorView_spacing,distance);
        typedArray.recycle();
    }

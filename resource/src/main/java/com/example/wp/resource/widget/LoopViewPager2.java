...
public class LoopViewPager2 extends ViewPager {
    ...
    public LoopViewPager2(Context context, AttributeSet attrs) {
        ...
        TypedArray a = getResources().obtainAttributes(attrs, R.styleable.LoopViewPager2);
        mIsAutoLoop = a.getBoolean(R.styleable.LoopViewPager2_lvp_isAutoLoop, mIsAutoLoop);
        mDelayTime = a.getInteger(R.styleable.LoopViewPager2_lvp_delayTime, mDelayTime);
        a.recycle();

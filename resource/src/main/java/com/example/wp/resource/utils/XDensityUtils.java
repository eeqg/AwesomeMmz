...
public class XDensityUtils {
    ...
    public static int sp2px(float spValue) {
        final float fontScale = BaseApp.INSTANCE.getResources().getDisplayMetrics().scaledDensity;
    ...
    public static int getScreenHeight() {
        return BaseApp.INSTANCE.getResources().getDisplayMetrics().heightPixels;
    }
    ...
    public static int getScreenRealHeight() {
        int h;
        WindowManager winMgr = (WindowManager) BaseApp.INSTANCE.getSystemService(Context.WINDOW_SERVICE);
    ...
    public static int getStatusBarHeight() {
        ...
        try {
            ...
            statusBarHeight = BaseApp.INSTANCE.getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
